...
const MacOSDock: React.FC<MacOSDockProps> = ({ 
  ...
  const handleMouseMove = useCallback((e: React.MouseEvent) => {
    ...
    if (dockRef.current) {
      ...
      // For rotated dock, use clientY and flip the calculation
      const relativeY = e.clientY - rect.top - padding;
      const maxY = rect.height - padding * 2;
      setMouseX(maxY - relativeY);
    }
  }, [baseIconSize]);
        ...
        {apps.map((app, index) => {
          ...
          return (
            <div
              ...
              className="absolute cursor-pointer flex flex-col items-center justify-end overflow-hidden rounded-md"
              title={app.name}
            ...
            >
              ...
              {/* Tooltip */}
              {hoveredApp === app.id && app.date && (
                <div 
                  className="absolute pointer-events-none z-[9999]"
                  style={{
                    left: `${scaledSize + 8}px`,
                    top: '50%',
